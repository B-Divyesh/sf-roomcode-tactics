...
The sample is an active five-turn Cypress Pass match (seed `CYPRESS-01`): Mira
is north, Teo is south, and Teo holds position while the visitor chooses
Mira’s moves. It has a real board, scores, one-point objectives, resolution
messages, and an end screen.
